<?php
        ...
        public function guardarEmpresa(){
                ...
                $empresaCode = substr(str_shuffle($permitted_chars), 0, 10);
                ...
                "altitudEmpresa"=>$this->altitudEmpresa,
        ...
        public static function obtenerEmpresa($codigoEmpresa){
                $contenidoArchivoEmpresas = file_get_contents("../data/empresas.json");
                $empresas = json_decode($contenidoArchivoEmpresas, true);
                $empresa = null;
        ...
        public function editarEmpresa($empresaCode){
                $contenidoArchivoEmpresas = file_get_contents("../data/empresas.json");
                $empresas = json_decode($contenidoArchivoEmpresas, true);
                $empresa = null;
                $productos = null;
