...
function validarCorreoLI(){
    ...
    if(correo.value == ""){
        ...
        if(validarEmail(correo.value) == false){
            document.getElementById("errorCorreosLI").innerHTML="";
            document.getElementById("errorCorreosLI").innerHTML += `<div style=" color: #DC3545"> El patrón ingresado es incorrecto. Debe ser user@example.com </div>`;
            document.getElementById("correo-login").classList.add("is-invalid");
            console.log("Correo: Campo vacio");
            correo.focus();
        }else{
            ...
            document.getElementById("errorCorreosLI").innerHTML="";
            document.getElementById("errorCorreosLI").innerHTML += `<div style=" color: green"> Looks Good! </div>`;
...
function validarContraseñaLI(){
    ...
    if(contraseña.value == ""){
        ...
        console.log("Contraseña: "+ document.getElementById("contraseña-login").value);
        return true;
    }
